...
namespace ThriftS.IDL
{
  ...
  [Serializable]
  #endif
  public partial class InternalServerException : TException, TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("InternalServerException");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("InternalServerException(");
      __sb.Append(", Request: ");
