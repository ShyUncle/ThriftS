...
namespace ThriftS.IDL
{
  ...
  [Serializable]
  #endif
  public partial class InvocationException : TException, TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("InvocationException");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("InvocationException(");
      __sb.Append(", Request: ");
